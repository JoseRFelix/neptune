...
import JoseRFelixNeptuneJoseRFelixNeptuneNeptune from './JoseRFelix/neptune/JoseRFelix.neptune.neptune'
...
export default { 
  JoseRFelixNeptuneJoseRFelixNeptuneNeptune: load(JoseRFelixNeptuneJoseRFelixNeptuneNeptune, 'JoseRFelix.neptune.neptune'),
